...
public enum ModArmorMaterials implements ArmorMaterial {
    TESTIUM_INGOT( "testium_ingot", 15, new int[] { 2, 6, 5, 2 }, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0f, 0.0f, () -> Ingredient.ofItems(ModItems.TESTIUM_INGOT) )
    ;
    ...
    public String getName() {
        return CascadianOres.MOD_ID + ":" + this.name;
    }
